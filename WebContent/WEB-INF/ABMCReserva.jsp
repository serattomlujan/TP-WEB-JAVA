...
<form>
		<title>
		</title><font face="arial"> <b>Reserva</font>
	</form><font face="arial">ID Reserva<input><font face="arial"> <i><b></b></i>
	</font><form>
	<font face="arial">Tipo Elemento<select style="width: 154px; height: 29px"></select><br></font>Fecha(aaaammdd)<input><button type="submit" style="color: black;  background-color: white; width: 115px">Buscar</button><br>Hora(hhmm)<input><br>Elemento<select style="width: 147px; height: 27px; "></select><br>Detalle<input style="width: 414px; height: 26px; "></form><form>
